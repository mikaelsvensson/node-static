...
this.Server = function (root, options) {
    ...
    this.options.customContentTypes = this.options.customContentTypes || {};
...
this.Server.prototype.respond = function (pathname, status, _headers, files, stat, req, res, finish) {
    ...
    if (req.headers['if-none-match'] === headers['Etag'] ||
        ...
        var pathExt = [path.extname(files[0]).slice(1)];
        headers['Content-Length'] = stat.size;
        headers['Content-Type']   = this.options.customContentTypes[pathExt] || 
                                    mime.contentTypes[pathExt] ||
